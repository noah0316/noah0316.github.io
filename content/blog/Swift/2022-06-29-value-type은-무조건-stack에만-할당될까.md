...
현재 valueTypeObject의 주소 `0x00007ff7bfeff2c0` 의 메모리영역을 한번 확인해봅시다!
...
사실 WWDC 2016 UnderStanding Swift Performance세션에서도 모든 ValueType이 무조건 Stack에 할당된다고 하지는 않았는데,
